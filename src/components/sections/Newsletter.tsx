    ...
    <section className="py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-5 lg:px-10">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-[2.5rem] bg-gradient-warm p-10 lg:p-20 text-center"
        >
          <div className="absolute -top-20 -right-20 size-[400px] rounded-full bg-[var(--gold)]/30 blur-3xl" />
          <div className="absolute -bottom-20 -left-20 size-[400px] rounded-full bg-[var(--sale)]/15 blur-3xl" />
